...
export default tseslint.config(
  ...
  {
    files: ["src/**/*.ts"], // Las reglas se aplican a todos los archivos .ts en cualquier lado de src/
  },
  {
    ignores: ["node_modules/", "dist/", "**/*.js"], //ignoramos todo lo que esta dentro de node_modules/, dist/ y todo los archivos .js
  },
  {
    rules: {
